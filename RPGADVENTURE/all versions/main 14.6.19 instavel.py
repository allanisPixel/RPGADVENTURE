...
#itens
'''
escudolv1PNG = pygame.image.load("escudo lv0.png")
escudolv1PNG = pygame.image.load("escudo lv1.png")
escudolv2PNG = pygame.image.load("escudo lv2.png")
escudolv3PNG = pygame.image.load("escudo lv3.png")

espadalv1PNG = pygame.image.load("espada lv0.png")
espadalv1PNG = pygame.image.load("espada lv1.png")
espadalv2PNG = pygame.image.load("espada lv2.png")
espadalv3PNG = pygame.image.load("espada lv3.png")

poçãolv1PNG = pygame.image.load("poção lv0.png")
poçãolv1PNG = pygame.image.load("poção lv1.png")
poçãolv2PNG = pygame.image.load("poção lv2.png")
poçãolv3PNG = pygame.image.load("poção lv3.png")
'''
...
#Itens
espada = [pygame.image.load("escudo lv0.png"),pygame.image.load("escudo lv1.png"),
...
espadaX, espadaY = 284,168
escudoX, escudoY = 284,168
poçãoX, poçãoY = 284,168
...
def lojinha1():
    global display, lojaAberta, lojinha, lojinhaX, lojinhaY, espada, espadaX, espadaY, escudo, escudoX, escudoY, poção, poçãoX, poçãoY
    while lojaAberta:
